...
* c++11やc++14などの現代のc++を使うことを前提として書かれています. なので今のc++では既に使う必要がないものは説明しません. ここで説明していないものを使った古いコードにこの先出会うことが多々あるでしょうがその都度調べて何が書いてあるか把握してください. **それらを使ったコードを書く必要はありません.**
